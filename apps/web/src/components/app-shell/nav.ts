...
export const NAV_GROUPS: NavGroup[] = [
  ...
  { items: [{ href: '/items', label: 'Items', icon: PackageIcon, permission: 'items:view' }] },
  {
    ...
    items: [
      ...
      { href: '/sales-receipts', label: 'Sales Receipts', icon: ScrollTextIcon, permission: 'sales_receipts:view' },
      { href: '/recurring-invoices', label: 'Recurring Invoices', icon: RefreshCwIcon, permission: 'recurring_invoices:view' },
